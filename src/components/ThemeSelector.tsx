...
function LightIcon(props: ComponentProps<"svg">) {
  return (
    <IconBase {...props}>
      <path
        fillRule="evenodd"
...
function DarkIcon(props: ComponentProps<"svg">) {
  return (
    <IconBase {...props}>
      <path
        fillRule="evenodd"
...
export function ThemeSelector(props: ComponentProps<"div">) {
