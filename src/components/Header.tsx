...
export function Header() {
  ...
  return (
    <header
      className={clsx(
        "sticky top-0 z-50 flex flex-wrap items-center justify-between bg-white/30 backdrop-blur-md px-4 py-5 shadow-md shadow-stone-900/5 transition duration-500 dark:shadow-none sm:px-6 lg:px-8",
        {
